...
enum ProjectileType
{
    ...
    PROJECTILE_FROSTSTAR = 14,
    PROJECTILE_FIRESPIKE = 15,
    NUM_PROJECTILES = 16
};
...
enum SeedType
{
    ...
    ENUM_AUTO_VALUE(SEED_ROCK)
    ENUM_AUTO_VALUE(SEED_EXPLODE_NUT)
    ...
    ENUM_AUTO_VALUE(SEED_FIRECACTUS)
    ENUM_AUTO_VALUE(SEED_FROSTSTARFRUIT)
...
enum ZombieType
{
    ...
    ENUM_AUTO_VALUE(ZOMBIE_WALLNUTNEWSPAPER)
    ...
    ENUM_AUTO_VALUE(ZOMBIE_PEA_HEAD_PAIL)
