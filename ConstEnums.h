...
enum ProjectileType
{
    ...
    PROJECTILE_PUFFPULT = 14,
    PROJECTILE_PLASMAPEA = 15,
    PROJECTILE_SOLARMELON = 16,
    PROJECTILE_PUFF4 = 17,
    NUM_PROJECTILES = 18
};
enum ReanimationType
{
    ...
    REANIM_SPIKEROCK,
    REANIM_THREEPEATER,
    REANIM_QUATROTHREEPEATER,
    REANIM_QUATRO_SUNFLOWER,
    REANIM_MARIGOLD,
    REANIM_ICESHROOM,
    REANIM_FIRESHROOM,
    ...
    REANIM_KERNELPULT,
    REANIM_MELONPULT,
    REANIM_SOLARMELONPULT,
    REANIM_COFFEEBEAN,
    REANIM_UMBRELLALEAF,
    REANIM_GATLINGPEA,
    REANIM_GATLINSNOWGPEA,
    REANIM_CATTAIL,
    REANIM_BUTTERCAT,
    REANIM_GLOOMSHROOM,
    REANIM_BOSS_ICEBALL,
...
enum SeedType
{
    ...
    ENUM_AUTO_VALUE(SEED_LASERREED)
    ENUM_AUTO_VALUE(SEED_TORCHWOOD)
    ENUM_AUTO_VALUE(SEED_MARIGOLD)
    ENUM_AUTO_VALUE(SEED_PEADRONE)   
    ...
    ENUM_AUTO_VALUE(SEED_CARROT)

    ENUM_AUTO_VALUE(SEED_GATLINSNOWGPEA)
    ...
    ENUM_AUTO_VALUE(SEED_SOLARMELONPULT)
    ENUM_AUTO_VALUE(SEED_FLOWERPOT)
    ENUM_AUTO_VALUE(SEED_KERNELPULT)  
    ENUM_AUTO_VALUE(SEED_UMBRELLA)
    ENUM_AUTO_VALUE(SEED_QUATROTHREEPEATER)
    ENUM_AUTO_VALUE(SEED_RANDOMTORCHWOOD)
    ENUM_AUTO_VALUE(SEED_QUATROSUNFLOWER)
    ENUM_AUTO_VALUE(SEED_BUTTERCAT)
    ...
    ENUM_AUTO_VALUE(SEED_ZOMBIE_PEASHOOTER)
...
enum TutorialState
{
    ...
    TUTORIAL_GLOVE_PICKUP = 15,
    TUTORIAL_GLOVE_DIG = 16,
    TUTORIAL_GLOVE_KEEP_DIGGING = 17,
    TUTORIAL_GLOVE_COMPLETED = 18,
...
enum ZombieType
{
    ...
    ENUM_AUTO_VALUE(ZOMBIE_SUBMARINE)
