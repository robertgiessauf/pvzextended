...
Image* Sexy::IMAGE_REANIM_WALLNUT_BODYO;
Image* Sexy::IMAGE_REANIM_WALLNUTO_CRACKED1;
Image* Sexy::IMAGE_REANIM_WALLNUTO_CRACKED2;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_PROJECTILEFIRECACTUS = aMgr.GetImageThrow("IMAGE_PROJECTILEFIRECACTUS");
		...
		IMAGE_PROJECTILE_FROSTSTAR = aMgr.GetImageThrow("IMAGE_PROJECTILE_FROSTSTAR");
		...
		IMAGE_REANIM_WALLNUT_BODYO = aMgr.GetImageThrow("IMAGE_REANIM_WALLNUT_BODYO");
		IMAGE_REANIM_WALLNUTO_CRACKED1 = aMgr.GetImageThrow("IMAGE_REANIM_WALLNUTO_CRACKED1");
		IMAGE_REANIM_WALLNUTO_CRACKED2 = aMgr.GetImageThrow("IMAGE_REANIM_WALLNUTO_CRACKED2");
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_PROJECTILEFIRECACTUS_ID: return "IMAGE_PROJECTILEFIRECACTUS";
		...
		case IMAGE_REANIM_WALLNUT_BODYO_ID: return "IMAGE_REANIM_WALLNUT_BODYO";
		case IMAGE_REANIM_WALLNUTO_CRACKED1_ID: return "IMAGE_REANIM_WALLNUTO_CRACKED1";
		case IMAGE_REANIM_WALLNUTO_CRACKED2_ID: return "IMAGE_REANIM_WALLNUTO_CRACKED2";
