...
bool Sexy::ExtractDelayLoad_Background10Resources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUND10 = aMgr.GetImageThrow("IMAGE_BACKGROUND10");
		IMAGE_BACKGROUND3_GAMEOVER_INTERIOR_OVERLAY = aMgr.GetImageThrow("IMAGE_BACKGROUND3_GAMEOVER_INTERIOR_OVERLAY");
		IMAGE_BACKGROUND3_GAMEOVER_MASK = aMgr.GetImageThrow("IMAGE_BACKGROUND3_GAMEOVER_MASK");
	}
	catch (ResourceManagerException&)
...
Image* Sexy::IMAGE_PUFFSHROOM_PUFF4;
Image* Sexy::IMAGE_PROJECTILE_PLASMA;
...
Image* Sexy::IMAGE_REANIM_SOLARMELON_PROJECTILE;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_PUFFSHROOM_PUFF4 = aMgr.GetImageThrow("IMAGE_PUFFSHROOM_PUFF4");
		IMAGE_PROJECTILE_PLASMA = aMgr.GetImageThrow("IMAGE_PROJECTILE_PLASMA");
		...
		IMAGE_REANIM_SOLARMELON_PROJECTILE = aMgr.GetImageThrow("IMAGE_REANIM_SOLARMELON_PROJECTILE");
...
static void* gResources[] =
{
	...
	&IMAGE_PUFFSHROOM_PUFF4,
	&IMAGE_PROJECTILE_PLASMA,
	&IMAGE_ZAMBONISMOKE,
	...
	&IMAGE_REANIM_SOLARMELON_PROJECTILE,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_PROJECTILE_PLASMA_ID: return "IMAGE_PROJECTILE_PLASMA";
		...
		case IMAGE_BACKGROUND10_ID: return "IMAGE_BACKGROUND10";
